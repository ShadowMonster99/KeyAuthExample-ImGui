...
namespace ImGui
{
    ...
    IMGUI_API void          ShowDemoWindow(bool* WindowOpen = NULL);        // create Demo window. demonstrate most ImGui features. call this to learn about the library! try to make it always available in your application!
    IMGUI_API void          ShowMetricsWindow(bool* WindowOpen = NULL);     // create Metrics/Debugger window. display Dear ImGui internals: windows, draw commands, various internal state, etc.
    IMGUI_API void          ShowAboutWindow(bool* WindowOpen = NULL);       // create About window. display Dear ImGui version, credits and build/system information.
    ...
    IMGUI_API bool          Begin(const char* name, bool* WindowOpen = NULL, ImGuiWindowFlags flags = 0);
    IMGUI_API void          End();
    ...
    IMGUI_API bool          BeginPopupModal(const char* name, bool* WindowOpen = NULL, ImGuiWindowFlags flags = 0); // return true if the modal is open, and you can start outputting to it.
    ...
    IMGUI_API bool          BeginTabItem(const char* label, bool* WindowOpen = NULL, ImGuiTabItemFlags flags = 0); // create a Tab. Returns true if the Tab is selected.
