...
static void ShowExampleAppDockSpace(bool* WindowOpen);
static void ShowExampleAppDocuments(bool* WindowOpen);
static void ShowExampleAppMainMenuBar();
static void ShowExampleAppConsole(bool* WindowOpen);
static void ShowExampleAppLog(bool* WindowOpen);
static void ShowExampleAppLayout(bool* WindowOpen);
static void ShowExampleAppPropertyEditor(bool* WindowOpen);
static void ShowExampleAppLongText(bool* WindowOpen);
static void ShowExampleAppAutoResize(bool* WindowOpen);
static void ShowExampleAppConstrainedResize(bool* WindowOpen);
static void ShowExampleAppSimpleOverlay(bool* WindowOpen);
static void ShowExampleAppFullscreen(bool* WindowOpen);
static void ShowExampleAppWindowTitles(bool* WindowOpen);
static void ShowExampleAppCustomRendering(bool* WindowOpen);
...
void ImGui::ShowDemoWindow(bool* WindowOpen)
{
    ...
    if (no_close)           WindowOpen = NULL; // Don't pass our bool* to Begin
    ...
    if (!ImGui::Begin("Dear ImGui Demo", WindowOpen, window_flags))
    {
...
void ImGui::ShowAboutWindow(bool* WindowOpen)
{
    if (!ImGui::Begin("About Dear ImGui", WindowOpen, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ImGui::End();
        return;
    }
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* WindowOpen)
    {
...
static void ShowExampleAppConsole(bool* WindowOpen)
{
    ...
    console.Draw("Example: Console", WindowOpen);
}
...
struct ExampleAppLog
{
    ...
    void    Draw(const char* title, bool* WindowOpen = NULL)
    {
        if (!ImGui::Begin(title, WindowOpen))
        {
            ImGui::End();
...
static void ShowExampleAppLog(bool* WindowOpen)
{
    ...
    ImGui::Begin("Example: Log", WindowOpen);
    ...
    log.Draw("Example: Log", WindowOpen);
}
...
static void ShowExampleAppLayout(bool* WindowOpen)
{
    ...
    if (ImGui::Begin("Example: Simple layout", WindowOpen, ImGuiWindowFlags_MenuBar))
    {
        if (ImGui::BeginMenuBar())
        {
            if (ImGui::BeginMenu("File"))
            {
                if (ImGui::MenuItem("Close")) *WindowOpen = false;
                ImGui::EndMenu();
            }
            ImGui::EndMenuBar();
        }
...
static void ShowExampleAppPropertyEditor(bool* WindowOpen)
{
    ...
    if (!ImGui::Begin("Example: Property editor", WindowOpen))
    {
        ImGui::End();
        return;
    }
...
{
    ImGui::SetNextWindowSize(ImVec2(520, 600), ImGuiCond_FirstUseEver);
    if (!ImGui::Begin("Example: Long text display", WindowOpen))
    {
        ImGui::End();
        return;
    }
...
static void ShowExampleAppAutoResize(bool* WindowOpen)
{
    if (!ImGui::Begin("Example: Auto-resizing window", WindowOpen, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ImGui::End();
        return;
    }
...
static void ShowExampleAppConstrainedResize(bool* WindowOpen)
{
    ...
    if (ImGui::Begin("Example: Constrained Resize", WindowOpen, flags))
    {
...
static void ShowExampleAppSimpleOverlay(bool* WindowOpen)
{
    ...
    if (ImGui::Begin("Example: Simple overlay", WindowOpen, window_flags))
    {
        ...
        if (ImGui::BeginPopupContextWindow())
        {
            ...
            if (WindowOpen && ImGui::MenuItem("Close")) *WindowOpen = false;
            ImGui::EndPopup();
        }
    }
    ImGui::End();
...
static void ShowExampleAppFullscreen(bool* WindowOpen)
{
    ...
    if (ImGui::Begin("Example: Fullscreen window", WindowOpen, flags))
    {
        ...
        if (WindowOpen && ImGui::Button("Close this window"))
            *WindowOpen = false;
    }
    ImGui::End();
}
...
static void ShowExampleAppCustomRendering(bool* WindowOpen)
{
    if (!ImGui::Begin("Example: Custom rendering", WindowOpen))
    {
        ImGui::End();
        return;
    }
...
void ShowExampleAppDockSpace(bool* WindowOpen)
{
    ...
    ImGui::Begin("DockSpace Demo", WindowOpen, window_flags);
    if (!opt_padding)
        ImGui::PopStyleVar();
    ...
    if (ImGui::BeginMenuBar())
    {
        if (ImGui::BeginMenu("Options"))
        {
            ...
            if (ImGui::MenuItem("Close", NULL, false, WindowOpen != NULL))
                *WindowOpen = false;
            ImGui::EndMenu();
        }
        HelpMarker(
...
void ShowExampleAppDocuments(bool* WindowOpen)
{
    ...
    bool window_contents_visible = ImGui::Begin("Example: Documents", WindowOpen, ImGuiWindowFlags_MenuBar);
