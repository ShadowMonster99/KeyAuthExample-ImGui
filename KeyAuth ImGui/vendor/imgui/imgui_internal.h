...
namespace ImGui
{
    ...
    IMGUI_API void          BeginDocked(ImGuiWindow* window, bool* WindowOpen);
    ...
    IMGUI_API bool          TabItemEx(ImGuiTabBar* tab_bar, const char* label, bool* WindowOpen, ImGuiTabItemFlags flags, ImGuiWindow* docked_window);
